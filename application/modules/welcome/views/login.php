...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" method="post" action="<?php echo base_url('logincheck');?>">
        ...
        <!--  <div class="form-group">
		  ...
		  <a href="<?php echo base_url('forgotpassword');?>"> <i class="fa fa-sign-in fa-lg fa-fw"></i>Forgot Password</a><br>
