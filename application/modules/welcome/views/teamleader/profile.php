          ...
          <div class="tab-content">
            <div class="tab-pane active" id="user-timeline">
			  ...
			  <h5><?php echo $this->session->flashdata('item');?></h5>
               ...
               <form method="post" action="<?php echo base_url('tl/changepassword');?>" enctype="multipart/form-data" >
                          <div class="col-md-8">
						  <div class="passs"></div>
            ...
            <div class="tab-pane fade" id="user-settings">
              <div class="tile user-settings">
				...
				<?php //foreach($pdatas as $pdata);?>
                <form method="post" action="<?php echo base_url('tl/profile');?>" enctype="multipart/form-data" >
                 <!-- <div class="row mb-4">
                    <div class="col-md-4">
