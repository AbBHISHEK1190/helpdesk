            ...
            <div class="tile-body">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
				  <?php foreach($gethelptopic as $tickets)if($tickets->sub_category !=''){{?>
                    <tr>
					<td><?php static $i=1; echo $i++; ?></td>
					 ...
					 <td><?php echo $tickets->sub_category;?></td>
                       <td><button class="btn" onclick="bloack('<?php echo $tickets->id;?>')" >delete</button></td>
						 ...
						 <button class="btn"   data-toggle="modal" data-target="#mysecondmodal" onclick="editedit('<?php echo $tickets->category;?>','<?php echo $tickets->id;?>')" type="button">Edit</button></td>
