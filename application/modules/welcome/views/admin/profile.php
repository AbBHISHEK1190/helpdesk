...
<img class="user-img" src="<?php echo base_url('');?>assets/images/128.jpg">
...
<?php }?>
            ...
            <div class="tab-pane active" id="user-timeline">
			  ...
			  <h5><?php echo $this->session->flashdata('item');?></h5>
			   <h4 class="line-head">Change Password</h4>
                <form method="post" action="<?php echo base_url('admin/changepassword');?>" enctype="multipart/form-data" >
                          <div class="col-md-8">
						  <div class="passs"></div>
             ...
             <!-- <div class="timeline-post">
                <div class="post-media"><a href="#"><img src="<?php echo base_url('');?>assets/images/48.jpg"></a>
                  <div class="content">
 ...
 <div class="col-md-8 mb-4">
				   ...
				   <div class="col-md-8 mb-4">
                    ...
                    <div class="col-md-8 mb-4">
                      <label>Address</label>
                      <textarea class="form-control" type="text" name="address" ><?php echo $pdata->address;?></textarea>
                    </div>
					<div class="clearfix"></div>
                    <div class="col-md-8 mb-4">
                      <label>state</label>
