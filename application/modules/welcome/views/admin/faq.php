...
function categorysd()
{
	var catid = document.getElementById("hthtth").value;
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
				  ...
				  <?php foreach($getfaq as $tickets)if($tickets->faq !=''){{?>
					...
					<td><?php static $i=1; echo $i++; ?></td>
					 ...
					 <td>
					   <?php $sql ="SELECT faq_ans.id,faq_ans.faq_ans FROM faq_ans  where faq_id='".$tickets->faqid."' ";
...
<td>
						...
						<button class="btn"   data-toggle="modal" data-target="#mythirdmodal" onclick="addadd('<?php echo $tickets->faqid;?>')" type="button">Add</button></td> <?php  }else {?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	   ...
	   <div class="form-group">
                ...
                <select class="form-control blockshow" id="hthtth" onchange="categorysd()">
				
				</select>
				</div>
<div class="form-group">
                  <label class="control-label">Sub Category</label>
                <select class="form-control sub_categoryss" id="mySelect">
...
$('#sususunxhaddfaqans').click(function()
{
	...
	if(departmentid !=='' && departmentid !==0)
	{
	 ...
	 $.ajax({
        type: "POST",
        url: "<?php echo base_url('admin/addfaqanss');?>",
        dataType: "html",
        data:{departmentid:departmentid,category:category}, 
        success: function(data){
       $('#result').html(data);
...
$('#sususunxhfourth').click(function()
{
 ...
 $.ajax({
        type: "POST",
        url: "<?php echo base_url('admin/editfaqans');?>",
        dataType: "html",
        data:{category:depart,departmentid:slatime}, 
        success: function(data){
