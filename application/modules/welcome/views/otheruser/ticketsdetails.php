...
<div class="col-6 article-body">
		   ...
		   <div class="tile col-md-8 offset-md-4">
            <div class="tile-body article-body"><h1><?php echo $me->message;?></h1><?php if($me->user_id =='0'){echo 'sent';}else {echo 'recived';}?>(<?php echo $me->created_date;?>)<?php if(!empty($me->attachments)){?><button class="btn"><i class="fa fa-download"></i><a href="<?php echo base_url('')?>assets/Createticket/<?php echo $me->attachments;?>" target="_blank"> Download</a></button> <?php }?></div>
              ...
              <div class="tile user-settings">
                ...
                <form method="post" id="submit" enctype="multipart/form-data">
                  ...
                  <div class="row">
                   ...
                   <input type="hidden" id="dep" name="department" value="<?php echo $data->department;?>" />
                   
                   <input type="hidden" id="t_id"  name="tid" value="<?php echo $data->ticket_id;?>" />
