              ...
              <form id="formoid" action="<?php echo base_url('create-ticket');?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <input class="form-control" type="mobile" name="mobile" placeholder="Enter mobile number" required onblur="phonenumber(this);">
                </div>
				<!-- <div class="form-group">
				...
				<div class="form-group">
                  <label class="control-label">Help Topic</label>
                <select class="form-control" name="help_topic" id="mySelect" onchange="category()" >
			  ...
			  <option><---Select---></option>
				...
				<div class="form-group">
                  <label class="control-label">Faq</label>
                   <select class="form-control  faq_category" name="faq">
			  <option><---Select---></option>
