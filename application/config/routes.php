...
$route['admin/department'] = 'welcome/Adminsetting/departmentlist';
$route['admin/adddepartment'] = 'welcome/Adminsetting/adddepartment';
$route['admin/deletefromdepart'] = 'welcome/Adminsetting/deletefromdepart';
$route['admin/editslatime'] = 'welcome/Adminsetting/editslatime';
$route['admin/helptopic'] = 'welcome/Adminsetting/helptopic';
$route['admin/addhelptopic'] = 'welcome/Adminsetting/addhelptopic';
$route['admin/deletefromhelptopic'] = 'welcome/Adminsetting/deletefromhelptopic';
$route['admin/edithelptopic'] = 'welcome/Adminsetting/edithelptopic';
$route['admin/faq'] = 'welcome/Adminsetting/faq';
$route['admin/categorysss'] = 'welcome/Adminsetting/categorysss';
$route['admin/addfaq'] = 'welcome/Adminsetting/addfaq';
$route['admin/deletefromfaq'] = 'welcome/Adminsetting/deletefromfaq';
$route['admin/editfaq'] = 'welcome/Adminsetting/editfaq';
$route['admin/editdepartment'] = 'welcome/Adminsetting/editdepartment';
$route['admin/approvestaff'] = 'welcome/Admin/approvestaff';
$route['admin/changepassword'] = 'welcome/Admin/changepassword';
$route['admin/subcategoty'] = 'welcome/Adminsetting/subcategoty';
$route['admin/adssubcategory'] = 'welcome/Adminsetting/adssubcategory';
$route['admin/editsubcat'] = 'welcome/Adminsetting/editsubcat';
$route['admin/deletefromsubcat'] = 'welcome/Adminsetting/deletefromsubcat';
$route['admin/faqanswers'] = 'welcome/Adminsetting/faqanswers';
$route['admin/addfaqanss'] = 'welcome/Adminsetting/addfaqanss';
$route['admin/editfaqans'] = 'welcome/Adminsetting/editfaqans';
$route['admin/deptranfer'] = 'welcome/Admin/deptranfer';
...
$route['tl/dep_tranfer'] = 'welcome/Teamleader/dep_tranfer';
